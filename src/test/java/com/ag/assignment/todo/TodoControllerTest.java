...
import com.ag.assignment.todo.ToDoService;
import com.ag.assignment.todo.Todo;
import com.ag.assignment.todo.TodoController;
...
public class TodoControllerTest extends AbstractRestControllerTest {
    ...
    public void testNotFoundException() throws Exception {
        ...
        when(todoService.getTodoById(anyLong())).thenThrow(com.ag.assignment.exception.ResourceNotFoundException.class);
